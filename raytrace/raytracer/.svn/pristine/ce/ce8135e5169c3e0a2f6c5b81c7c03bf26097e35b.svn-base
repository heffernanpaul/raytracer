...
void write_binary_item(FILE *, int, unsigned int, float, int);
void write_ascii_item(FILE *, int, unsigned int, float, int);
float old_write_ascii_item(FILE *, char *, int);
...
void store_item(char *, int, int, unsigned int, float);

/* return the value of a stored item */
void get_stored_item( void *, int, int *, unsigned int *, float *);

/* return the value stored in an item, given ptr to it and its type */
float get_item_value(char *, int);

/* get binary or ascii item and store it according to ptr and type */
void get_ascii_item(char *, int, int *, unsigned int *, float *);
void get_binary_item(FILE *, int, int *, unsigned int *, float *);
...
Exit:
  returns a float-precision float that contains the value of the item
******************************************************************************/

float get_item_value(char *item, int type)
{
...
Entry:
  ...
  double_val - float-precision float version of item
...
Exit:
  returns a float-precision float that contains the value of the written item
******************************************************************************/

float old_write_ascii_item(FILE *fp, char *item, int type)
{
  unsigned char *puchar;
  char *pchar;
  short int *pshort;
...
into an integer, an unsigned integer and a float.
...
Exit:
  ...
  double_val - float-precision floating point value
******************************************************************************/
...
Entry:
  ...
  double_val - float version of value
