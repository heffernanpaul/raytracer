...
Rectangle3D::Rectangle3D(const Point3D& _p0, const Vector3D& _a, const Vector3D& _b)
	:	GeometricObject(),
		p0(_p0),
		a(_a),
		b(_b),
...
Rectangle3D::Rectangle3D(const Point3D& _p0, const Vector3D& _a, const Vector3D& _b, const Normal& n)
	:	GeometricObject(),
		p0(_p0),
		a(_a),
		b(_b),
...
Rectangle3D::Rectangle3D (const Rectangle3D& r)
	:	GeometricObject(r),
		p0(r.p0), 
		a(r.a),
		b(r.b),
...
Normal 										
Rectangle3D::get_normal(const Point3D& p) {
	return (normal);
}
