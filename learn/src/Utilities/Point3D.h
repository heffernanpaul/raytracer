...
class Point3D {
	public:
		...
		Point3D(const float a);									// constructor
		Point3D(const float a, const float b, const float c);	// constructor
		...
		float														// square of distance bertween two points
		d_squared(const Point3D& p) const;
		
		float														// distance bewteen two points
